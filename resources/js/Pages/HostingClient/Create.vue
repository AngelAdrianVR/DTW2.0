...
<template>
    <AppLayout title="Añadir Servicio">
            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submit">
                    <div class="bg-white dark:bg-[#1C1C1E] border border-gray-100 dark:border-zinc-800 shadow-sm rounded-[2rem] p-8">
                        <div class="mb-8">
                            <h2 class="text-3xl font-bold text-gray-800 dark:text-white tracking-tight">Nuevo Servicio</h2>
                            <p class="text-gray-500 dark:text-zinc-400 mt-1">Registra un nuevo plan de hosting o sistema externo.</p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <InputText id="service_provider" v-model="form.service_provider" class="!rounded-xl" :class="{ 'p-invalid': form.errors.service_provider }" placeholder="Ej. Nuestro, AWS, Hostinger" />
                        ...
                        <Divider align="left" type="solid" class="my-8">
                            <span class="text-gray-500 dark:text-zinc-400 text-sm font-bold uppercase tracking-wider">Dominios / URLs Alojados</span>
                        </Divider>
                        ...
                        <div class="flex justify-end gap-3 mt-10 pt-6 border-t border-gray-100 dark:border-zinc-800">
                            ...
                            <Button label="Guardar Servicio" icon="pi pi-check" @click="submit" :loading="form.processing" class="!rounded-xl p-button-sm !text-[var(--primary-text-color)]"/>
                        </div>
                    </div>
                </form>
            </div>
