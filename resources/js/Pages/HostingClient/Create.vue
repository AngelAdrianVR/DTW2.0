                ...
                <form @submit.prevent="submit">
                    <Card class="dark:bg-zinc-900 dark:border-zinc-800 border border-gray-100 shadow-sm rounded-2xl">
                        ...
                        <template #content>
                            ...
                            <div v-for="(item, index) in form.hosted_urls" :key="index" class="grid grid-cols-1 md:grid-cols-5 gap-4 items-center mb-4 p-4 bg-gray-50 dark:bg-zinc-800/50 border border-gray-100 dark:border-zinc-800 rounded-xl relative transition-all">
                               <div class="flex flex-col gap-2 md:col-span-4">
                                    <label :for="'url_' + index" class="font-semibold text-xs text-gray-600 dark:text-zinc-400">URL del Sitio</label>
                        ...
                        <template #footer>
                            <div class="flex justify-end gap-3 pt-4 border-t border-gray-100 dark:border-zinc-800">
                                ...
                                <Button label="Guardar Servicio" icon="pi pi-check" @click="submit" :loading="form.processing" class="!text-[var(--primary-text-color)]"/>
                            </div>
                        </template>
                    </Card>
                </form>
