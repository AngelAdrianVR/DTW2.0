...
const form = useForm({
    ...
    support_user: props.hostingClient.support_user || '',
    support_password: props.hostingClient.support_password || '',
            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submit">
                    <Card class="dark:bg-zinc-900 dark:border-zinc-800 border border-gray-100 shadow-sm rounded-2xl">
                        ...
                        <template #subtitle>
                            <p class="text-gray-500 dark:text-zinc-500">Actualiza la información del plan o sistema.</p>
                        </template>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                               ...
                               <div class="flex flex-col gap-2">
                                ...
                                <div class="flex flex-col gap-2">
                                 ...
                                 <div class="flex flex-col gap-2">
                                    <label for="start_date" class="font-semibold text-sm text-gray-700 dark:text-zinc-300">Fecha de Inicio <span class="text-red-500">*</span></label>
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <InputText id="support_user" v-model="form.support_user" :class="{ 'p-invalid': form.errors.support_user }" />
                                </div>
                                <div class="flex flex-col gap-2">
                                    <label for="support_password" class="font-semibold text-sm text-gray-700 dark:text-zinc-300">Contraseña</label>
                                    <InputText id="support_password" v-model="form.support_password" :class="{ 'p-invalid': form.errors.support_password }" />
                                </div>
