            ...
            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
                <form @submit.prevent="submit">
                    <Card class="dark:bg-zinc-900 dark:border-zinc-800 border border-gray-100 shadow-sm rounded-2xl">
                        <template #title>
                            <h2 class="text-2xl font-bold text-gray-800 dark:text-zinc-100">Crear Nuevo Cliente</h2>
                        </template>
                        <template #subtitle>
                            <p class="text-gray-500 dark:text-zinc-500">Completa la información para registrar un nuevo cliente en el sistema.</p>
                        </template>
                        ...
                        <template #footer>
                            <div class="flex justify-end gap-3 mt-6 pt-4 border-t border-gray-100 dark:border-zinc-800">
                                ...
                                <Button label="Guardar Cliente" icon="pi pi-check" class="!text-[var(--primary-text-color)]" @click="submit" :loading="form.processing" />
                            </div>
                        </template>
                    </Card>
                </form>
