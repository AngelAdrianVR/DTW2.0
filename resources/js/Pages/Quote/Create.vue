...
import DatePicker from 'primevue/datepicker'; // Corregido: Se usa DatePicker en lugar de Calendar
...
const form = useForm({
    ...
    description: null,
    amount: null,
    valid_until: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000), // Usar objeto Date para DatePicker
    payment_type: null,
    work_days: null,
...
// Nuevo: Calcula el total con el descuento aplicado
                ...
                <form @submit.prevent="submit">
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
                        ...
                        <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                            <header class="mb-6">
                                <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-200">Crear Cotización</h1>
                                <p class="text-gray-500 dark:text-gray-400 mt-1">Completa los datos para generar una nueva cotización.</p>
                            </header>
                            ...
                            <div class="flex justify-end gap-2 mt-8">
                                ...
                                <Button type="submit" label="Guardar Cotización" icon="pi pi-check" :loading="form.processing" />
                            </div>
                        </div>
                        ...
                        <div class="bg-white shadow-lg rounded-lg p-8 font-sans text-sm text-gray-700">
                           <header class="flex justify-between items-start pb-6 border-b">
                                ...
                                <div class="text-right">
                                    ...
                                    <p class="font-mono mt-1">Folio: COT-XXXX</p>
