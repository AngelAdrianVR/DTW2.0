                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-[1fr_400px] xl:grid-cols-[1fr_550px] gap-8 items-start">
                        ...
                        <div class="bg-white dark:bg-zinc-900 shadow-sm border border-gray-100 dark:border-zinc-800 rounded-2xl p-6 lg:p-8 apple-form">
                            <header class="mb-6 pb-4 border-b border-gray-100 dark:border-zinc-800 flex justify-between items-center">
                                <div>
                                    <h1 class="text-2xl font-semibold text-gray-900 dark:text-zinc-100 tracking-tight">Nueva Cotización</h1>
                                    <p class="text-xs text-gray-500 dark:text-zinc-500 mt-1">Completa los datos del proyecto y términos comerciales.</p>
                                </div>
                                <Button type="submit" label="Guardar" icon="pi pi-check" :loading="form.processing" class="!rounded-xl p-button-sm !text-[var(--primary-text-color)]" />
                            </header>
                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <InputText id="title" v-model="form.title" :class="{ 'p-invalid': form.errors.title }" placeholder="Ej: Rediseño de Sitio Web" />
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 bg-gray-50/50 dark:bg-zinc-800/20 p-4 rounded-xl border border-gray-50 dark:border-zinc-800/50">
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <InputNumber id="amount" v-model="form.amount" mode="currency" currency="MXN" locale="es-MX" :class="{ 'p-invalid': form.errors.amount }" placeholder="$0.00" />
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <InputNumber id="amount_usd" v-model="form.amount_usd" mode="currency" currency="USD" locale="en-US" :class="{ 'p-invalid': form.errors.amount_usd }" placeholder="$0.00" />
                                    </div>
                                     <div class="flex flex-col gap-1">
                                        <label for="percentage_discount" class="text-[11px] font-semibold text-gray-500 uppercase tracking-wider">Descuento (%)</label>
                                        <InputNumber id="percentage_discount" v-model="form.percentage_discount" :min="0" :max="100" suffix=" %" :class="{ 'p-invalid': form.errors.percentage_discount }" placeholder="0 %" />
                                    </div>
                                </div>
                        ...
                        <div class="sticky top-6 shadow-2xl rounded-xl border border-gray-200 overflow-hidden h-fit max-h-[calc(100vh-3rem)] overflow-y-auto hidden lg:block">
                           ...
                           <QuotePreview :data="form" :client="selectedClient" quoteId="XXXX" :createdAt="today" currency="MXN" />
                        </div>
                    </div>
                </form>
            </div>
