...
// State for PrimeVue primary color
...
// Methods to update and manage the primary color
                ...
                <div v-if="item.show" class="px-4">
                    ...
                    <div v-if="item.children" class="relative">
                        <button @click="toggleGroup(item.name)" class="flex items-center justify-between w-full p-2 rounded-lg transition-colors duration-200"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 transition-transform duration-200" :class="{'rotate-90': openGroups[item.name]}" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg>
                        </button>
